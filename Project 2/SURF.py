...
surf = cv2.xfeatures2d_SURF.create(5000)
keys, desc = surf.detectAndCompute(hotel, None)
keys1, desc1 = surf.detectAndCompute(hotel1, None)
keys2, desc2 = surf.detectAndCompute(hotel2, None)
keys3, desc3 = surf.detectAndCompute(hotel3, None)
...
keys01, desc01 = surf.detectAndCompute(pan01, None)
...
keys012, desc012 = surf.detectAndCompute(pan012, None)
